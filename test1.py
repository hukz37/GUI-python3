...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tabWidget.setGeometry(QtCore.QRect(0, 20, 596, 421))
        ...
        self.widget = QtWidgets.QWidget(self.tab_16)
        self.widget.setGeometry(QtCore.QRect(70, 50, 481, 251))
        ...
        self.horizontalLayout_64.addWidget(self.lineEdit_41)
        ...
        self.horizontalLayout_65.addWidget(self.lineEdit_42)
        ...
        self.horizontalLayout_66.addWidget(self.lineEdit_43)
        ...
        self.lineEdit_14.setGeometry(QtCore.QRect(480, 0, 113, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_50.setText(_translate("MainWindow", "状态"))
        self.lineEdit_41.setText(_translate("MainWindow", "1"))
        self.label_51.setText(_translate("MainWindow", "名称"))
        self.label_52.setText(_translate("MainWindow", "地址"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_16), _translate("MainWindow", "视频"))
